//[lib](../../../index.md)/[com.github.hongkongkiwi.certificateutils](../index.md)/[[androidJvm]CertificateUtils](index.md)/[GENERIC_PRIVATE_KEY_MARKERS](-g-e-n-e-r-i-c_-p-r-i-v-a-t-e_-k-e-y_-m-a-r-k-e-r-s.md)
